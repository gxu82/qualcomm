...
#define HANDLE_GAIA_SERVICE_END         (0x001b)
...
#define HANDLE_GAIA_DATA_CLIENT_CONFIG  (0x001b)
#define HANDLE_BATTERY_SERVICE1         (0x001c)
#define HANDLE_BATTERY_SERVICE1_END     (0x0020)
#define HANDLE_BATTERY_LEVEL1           (0x001e)
#define HANDLE_BATTERY_LEVEL_PRESENTATION1 (0x001f)
#define HANDLE_BATTERY_LEVEL_CLIENT_CONFIG1 (0x0020)
#define HANDLE_BATTERY_SERVICE2         (0x0021)
#define HANDLE_BATTERY_SERVICE2_END     (0xffff)
#define HANDLE_BATTERY_LEVEL2           (0x0023)
#define HANDLE_BATTERY_LEVEL_PRESENTATION2 (0x0024)
#define HANDLE_BATTERY_LEVEL_CLIENT_CONFIG2 (0x0025)
