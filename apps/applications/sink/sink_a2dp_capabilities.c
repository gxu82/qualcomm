...
#define REPEAT_OCTET_23_TIMES(x) REPEAT_OCTET_10_TIMES(x), REPEAT_OCTET_10_TIMES(x), x, x, x

#define LENGTH_OF_CP_TYPE_SCMS_VALUE (2)

#define RESERVED     (0x00)
#define UNUSED_OCTET (0x00)
...
typedef enum
{
    ...
    length_of_aptx_adaptive_cap = 19,
#else
...
#define APTX_AD_LL_TTP_MIN_IN_1MS  0
#define APTX_AD_LL_TTP_MAX_IN_4MS  75
#define APTX_AD_HQ_TTP_MIN_IN_1MS  0
#define APTX_AD_HQ_TTP_MAX_IN_4MS  75
#define APTX_AD_TWS_TTP_MIN_IN_1MS 100
#define APTX_AD_TWS_TTP_MAX_IN_4MS 75

#ifdef INCLUDE_APTX_ADAPTIVE
/*! @name Default aptX Adaptive Capabilities
    Default capabilities that an application can pass to the A2DP library during initialisation.
*/
#ifdef USE_DEPRECATED_APTX_AD_SERVICE_CAP
uint8 aptx_ad_caps_sink[29] =
#else
...
#ifndef USE_DEPRECATED_APTX_AD_SERVICE_CAP
    REPEAT_OCTET_23_TIMES(RESERVED),
#endif
...
#ifdef INCLUDE_APTX_ADAPTIVE
/*!
 * @brief True Wireless Stereo service capability for aptX Adaptive
*/
#ifdef USE_DEPRECATED_APTX_AD_SERVICE_CAP
const uint8 tws_aptx_ad_caps[39] =
#else
