...
bool sinkHandleAutoPowerOff(Task task, sinkState lState)
{
    ...
    switch ( lState )
    {
        ...
        /* case deviceConnDiscoverable: lwy modify 20191028*/
        ...
        /* case deviceA2DPStreaming: lwy modify 20191028*/
        ...
        case deviceConnected://add by lwy
        case deviceConnDiscoverable://add by lwy
        case deviceA2DPStreaming://add by lwy
