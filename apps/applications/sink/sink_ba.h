...
/*!
    @brief sinkBroadcastAudioInit(). This interface could be used
...
#else
#define sinkBroadcastAudioInit() ((void) (0))
#endif
...
/*!
    ...
    Broadcast Audio configure Must be invoked before using sinkBroadcastAudioInit() API.
