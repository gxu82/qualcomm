...
/**
  ...
  * @return The local time converted to transport time.
  */
rtime_t ErasureCodingTxTimeLocalToTransport(ec_handle_tx_t handle, rtime_t local_time);
...
/**
  ...
  * @return The transport time converted to local time. A 32-bit time value.
  ...
  */
rtime_t ErasureCodingRxTimeTransortToLocal(ec_handle_rx_t handle, rtime_t transport_time);
