...
#define L2CA_RES_TABLE \
    ...
    L2CA_RES_TABLE_X(L2CA_RESULT_FLOW_VIOLATION,            L2CA_RES_TABLE_DUMMY)                      /*!< LE Flow control protocol violation (either received credit count
...
#define L2CA_DISCRES_TABLE \
    ...
    L2CA_RES_TABLE_X(L2CA_DISCONNECT_FLOW_VIOLATION,    = L2CA_RESULT_FLOW_VIOLATION)
...
typedef struct
{
    ...
    l2ca_cid_t          cid;        /*!< Channel identifier */
    uint16_t            context;    /*!< Opaque context number returned in response*/
...
typedef struct
{
    ...
    phandle_t           phandle;    /*!< Destination phandle */
    l2ca_cid_t          cid;        /*!< Channel identifier */
    uint16_t            context;    /*!< Opaque context number from request */
