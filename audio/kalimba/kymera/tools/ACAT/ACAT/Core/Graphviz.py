...
# CONFIDENTIAL
#
# Copyright (c) 2017 - 2018 Qualcomm Technologies, Inc. and/or its
...
def add_ep_img(
        ep_id, details, sub_graph, ep_title, current_proc
    ):
    """
    ...
    @param[in] current_proc Current processor being analysed
    """
    tooltip = ep_title
...
def create_graph(
        endpoints, transforms, operators, proc
    ):
    """
