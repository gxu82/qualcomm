...
class HeapPmMem(NewHeapPmMem):
    ...
    def _get_heap_property(self, heap_number):
        ...
        try:
            ...
            patch_size = 0
        # Stre has an extra 6K PM Heap for P1 since patch 4881
        stre_pm_heap_p1_extra = 0x1800
        ...
        if patch_available_p1_ext and is_aurachip:
            if heap_number > 2:
                ...
                available = True
                heap_size = stre_pm_heap_p1_extra
        ...
        try:
            ...
            if heap_number == 0:
                ...
                if patch_available_p1_ext and is_aurachip:
                    ...
                    heap_size = heap_size - stre_pm_heap_p1_extra
