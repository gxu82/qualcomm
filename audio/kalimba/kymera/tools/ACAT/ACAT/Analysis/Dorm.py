...
class Dorm(Analysis.Analysis):
    ...
    def analyse_dorm_state(self):
        ...
        """
        try:
            # The elements of kip_table are indexed by dormid, and the values
            # are or's of bits given by dorm_state.  Each bit indicates we
            # can or can't go into shallow sleep.
