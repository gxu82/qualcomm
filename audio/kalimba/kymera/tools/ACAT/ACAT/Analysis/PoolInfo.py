...
class PoolInfo(Analysis.Analysis):
    ...
    def get_block_from_addr(self, address):
        """
        Get information about the pmalloc block associated with a given DM
    ...
    def clear_watermarks(self):
        """
        Clears the minimum available memory watermark by equating it with
    ...
    def _lookup_debuginfo(self):
        """
        Queries debuginfo for information we will need to get the memory
        pool usage
    ...
    def _is_core_offloaded(self):
        """
        Returns True, if the core is offloaded.
        @param[in] self Pointer to the current object
        """
